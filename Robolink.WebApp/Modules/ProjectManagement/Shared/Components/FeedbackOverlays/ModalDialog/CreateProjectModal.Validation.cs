...
public partial class CreateProjectModal : ComponentBase
{
    ...
    private void ValidateField(string fieldName, object? fieldValue)
    {
        ...
        switch (fieldName)
        {
            ...
            {
                if (fieldValue is Guid clientGuid && clientGuid == Guid.Empty)
            ...
            {
                // Fix: use 'Guid' pattern matching for a boxed Guid value.
                if (fieldValue is Guid managerGuid && managerGuid == Guid.Empty)
